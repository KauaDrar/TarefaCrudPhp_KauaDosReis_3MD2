		...
		<div class="row linha">
			<div class="col-sm">
				...
				?>
					...
					<button class="btn estilo-btn" onclick="window.location.href='alterarCliente.php?id=<?php echo $row['codigo'];?>'">
						Alterar
					</button>
					
					<button class="btn estilo-btn-outline" onclick="window.location.href='excluirCliente.php?id=<?php echo $row['codigo'];?>'">
						Excluir
					</button>
