				...
				<?php  
					...
					{	   
						...
						while($row = $select->fetch()) 
						{
							...
							echo "<br><b>Categoria: </b>".$row['cat'];
							echo "<br><b>Preço: </b>".$row['preco']; 
							echo "</p>";
				?>

					<button class="btn estilo-btn" onclick="window.location.href='alterarProduto.php?id=<?php echo $row['codigo'];?>'">
						Alterar
					</button>
					
					<button class="btn estilo-btn-outline" onclick="window.location.href='excluirProduto.php?id=<?php echo $row['codigo'];?>'">
						Excluir
					</button>
