		...
		<div class="row linha">
			...
			<?php  
				...
				?>
					...
					<button class="btn estilo-btn" onclick="window.location.href='alterarUsuario.php?id=<?php echo $row['codigo'];?>'">
						Alterar
					</button>
					
					<button class="btn estilo-btn-outline" onclick="window.location.href='excluirUsuario.php?id=<?php echo $row['codigo'];?>'">
						Excluir
					</button>
