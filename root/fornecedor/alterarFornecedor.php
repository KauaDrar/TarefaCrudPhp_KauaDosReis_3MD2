  ...
  <nav class="navbar navbar-expand-lg navbar-dark navegacao">
	...
	<div class="container formulario">
			<form action="confirmaAlterarFornecedor.php" method="POST">
			  	<div class="row linha">
				  <div class="col-sm-6">
						<label for="fname" class="form-label">Código:</label>
				...
				<div class="row linha">
					<div class="col-sm-6">
						<label for="fUF" class="form-label">Estado:</label>
						<input type="text" class="form-control" name="uf" id="uf">
					</div>
					<div class="col-sm-6">
						<label for="fNumero" class="form-label">Número:</label>
						<input type="text" class="form-control" name="numero" id="numero" value="<?php echo $row['numero'];?>" >
					</div>
				</div>
				<div class="row linha">
					<div class="col-sm-6">
						<label for="fTel" class="form-label">Telefone:</label>
						<input type="text" class="form-control" name="telefone" value="<?php echo $row['telefone'];?>"  required>
					</div>
					<div class="col-sm-6">
