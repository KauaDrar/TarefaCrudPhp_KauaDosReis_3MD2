		...
		<div class="row linha">
			...
			<?php  
				...
				?>
					...
					<button class="btn estilo-btn" onclick="window.location.href='alterarFornecedor.php?id=<?php echo $row['codigo'];?>'">
						Alterar
					</button>
					
					<button class="btn estilo-btn-outline" onclick="window.location.href='excluirFornecedor.php?id=<?php echo $row['codigo'];?>'">
						Excluir
					</button>
