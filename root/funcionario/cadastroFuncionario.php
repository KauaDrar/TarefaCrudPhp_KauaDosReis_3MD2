...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark navegacao">
	...
	<div class="jumbotron">
				...
				<h1 class="text-center" style="color:#ffffff" >Cadastro do Funcionário</h1>
</div>
			<form action="#" method="POST">
			<div class="row linha">
					<div class="col-sm">
			  	...
			  	<div class="row linha">
					...
					<div class="col-sm-6">
						...
						<input type="text" class="form-control" id="rgFuncionario" name="rgFuncionario">
					</div>
				</div>
			  	<div class="row linha">
					<div class="col-sm-6">
						<label for="cep" class="form-label">CEP:</label>
						<input type="text" class="form-control" id="cep" name="cepFuncionario" onblur="pesquisacep(this.value);">
					</div>
					<div class="col-sm-6">
				...
				<div class="row linha">
					...
					<div class="col-sm-6">
						<label for="numFuncionario" class="form-label">Número:</label>
						<input type="text" class="form-control" id="numFuncionario" name="numFuncionario">
					</div>
				</div>
				<div class="row linha">
					<div class="col-sm-6">
						<label for="celularFuncionario" class="form-label">Celular:</label>
						<input type="text" class="form-control" id="celularFuncionario" name="celularFuncionario">
					</div>
					<div class="col-sm-6">
...
if(!empty($_POST))
{
	...
	try {
	  ...
	  $stmt = $conn->prepare("INSERT INTO funcionario (nome, cpf, rg, cep, numero, celular, email)
