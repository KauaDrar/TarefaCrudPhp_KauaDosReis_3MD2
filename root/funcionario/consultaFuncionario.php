		...
		<div class="row linha">
			...
			<?php  
				...
				?>
					...
					<button class="btn estilo-btn" onclick="window.location.href='alterarFuncionario.php?id=<?php echo $row['codigo'];?>'">
						Alterar
					</button>
					
					<button class="btn estilo-btn-outline" onclick="window.location.href='excluirFuncionario.php?id=<?php echo $row['codigo'];?>'">
						Excluir
					</button>
